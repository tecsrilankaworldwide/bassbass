    ...
    <div className="min-h-screen bg-[#FAF9F6]">
      ...
      <div className="relative bg-gradient-to-br from-[#0B2545] via-[#133C55] to-[#0B2545] py-16 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="mb-6">
            <div className="inline-block bg-[#0B2545] px-8 py-3 mb-4">
              <span className="text-white text-lg sm:text-xl font-bold tracking-wider uppercase" style={{fontFamily:'DM Sans, sans-serif'}}>
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row items-center gap-3 max-w-2xl mx-auto mb-4" data-testid="search-form">
            ...
            <button type="submit" className="w-full sm:w-auto px-8 py-3.5 bg-[#FFC107] text-[#0B2545] font-bold rounded-full hover:bg-[#FFD54F] active:scale-95 transition-all shadow-lg shadow-[#FFC107]/30" data-testid="search-btn">
              {t('home.search')}
            </button>
          </form>
